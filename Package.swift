...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "GdkPixbuf", url: "https://github.com/mikolasstuchlik/SwiftGdkPixbuf.git", .branch("main")),
        .package(name: "PangoCairo", url: "https://github.com/mikolasstuchlik/SwiftPangoCairo.git", .branch("main")),
    ],
    targets: [
